...
1. 披露了为确保部分独立功能的实现所需要事先请求的系统权限及接入的第三方 SDK 情况。
...
欢迎使用 H Band ！H Band 是张家福开发的免费应用程序（以下简称“H Band”“我们”“我们的服务”或“我们的产品”）。
...
我们会使用您的信息以帮助您改善您的健康状况，管理您的智能穿戴设备：
...
我们不会主动从深圳市腾讯计算机系统有限公司外的第三方获取你的个人信息。如为业务发展需要从未在下方说明的第三方获取您的个人信息，我们会依法核实来源的合法性，或在获取前向您明示您个人信息的来源、类型及使用范围，如 H Band 开展业务需进行的个人信息处理活动超出您原本向第三方提供个人信息时的授权同意范围，我们将在处理您的这些个人信息前，征得您的明示同意；此外，我们也将会严格遵守相关法律法规的规定，并要求第三方保障其提供的信息的合法性。
...
- 数据备份：如果安装应用程序的安卓设备丢失或失窃，您将可以恢复所有数据；
- 无需靠近安装应用程序的安卓设备，也可以进行测量；
...
我们建议您定期登录H Band 账号，并确认您的个人数据准确且为最新。如果您对数据的准确性有疑问，请告知我们，我们将采取措施以纠正或删除不准确的数据。
...
| REQUEST_IGNORE_BATTERY_OPTIMIZATIONS                   | 电池优化          | 用于用户自己控制App 的耗电优化                         | 系统设置           | 是               | 设置 - 电池 - 应用               |
...
| ~~谷歌地图 SDK~~ | ~~谷歌公司~~             | ~~用于展示地图~~                 | ~~设备识别信息、位置信息~~ | ~~https://developers.google.cn/maps/~~   |
| ~~谷歌定位 SDK~~ | ~~谷歌公司~~             | ~~用于实现定位~~                 | ~~设备识别信息、位置信息~~ | ~~https://developers.google.cn/maps/~~   |
