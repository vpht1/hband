...
**10.7 当用户使用此软件，或要求 H Band 提供特定服务时，软件可能呼叫第三方系统或软件以支持用户的使用或存取。使用或存取结果将由第三方提供。H Band不保证通过支持该系统或软件所取得结果的安全性、准确性及有效性，亦不保证任何其他不确定性风险；如果因此产生任何争议或损失，H Band 将不承担任何责任。**
